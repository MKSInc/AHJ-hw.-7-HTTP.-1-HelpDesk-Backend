### [Heroku server](https://ahj-7-1-helpdesk.herokuapp.com/)
...
## 7.1 HelpDesk (Backend)

### Описание задания во [Frontend](https://github.com/MKSInc/AHJ-hw.-7-HTTP.-1-HelpDesk-Frontend) части.
